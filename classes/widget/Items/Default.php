 ...
 * @abstract 
 */
abstract class MP_Profit_Plugin_Widget_Default extends WP_Widget {
    ...
    function __construct() {
        if (!defined('THEMENAMEPROFIT')) {
            define('THEMENAMEPROFIT', 'Profit');
        }
        $this->setPrefix('mp-profit');
        $this->setTextdomain('mp-profit');
    ...
    protected function getTranslatedName() {
        return THEMENAMEPROFIT . $this->getNameDelimiter() . $this->getName();
    }
